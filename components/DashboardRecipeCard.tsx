...
export default function DashboardRecipeCard({
  ...
  return (
    <div
      ...
      className={`group relative bg-white border-2 rounded-[2rem] overflow-hidden transition-all h-fit duration-300 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 ${
        isSelected
    ...
    >
      <div
        className={`absolute top-4 right-4 z-10 size-8 md:size-6 rounded-full border-2 flex items-center justify-center transition-all ${
          isSelected
      ...
      <div className="relative h-48 bg-neutral-100 overflow-hidden">
        {recipe.image_url ? (
          ...
          <div className="object-cover w-full h-full bg-neutral-800 transition-transform duration-700 group-hover:scale-110" />
        )}
      </div>
